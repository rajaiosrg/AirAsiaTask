...
class CoreDataStack  {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        let modelUrl = Bundle.main.url(forResource: "AirAsia", withExtension: "momd")!
    ...
    lazy var peristentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let persistentStoreUrl: URL = applicationDocumentsDirectory.appendingPathComponent("AirAsia.sqlite")
